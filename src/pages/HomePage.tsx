          ...
          <div className="row align-items-center gy-5">
            ...
            <div className="col-lg-6 ps-lg-5">
              <Reveal className="w-100 reveal-right">
                ...
                <p className="section-body">Al Burhaniya International was founded in 2006 with a simple but powerful belief — that a neighbourhood is only as strong as its bonds. Over nearly two decades, we have grown into a thriving hub of culture, sport, arts, learning, and mutual care.</p>
